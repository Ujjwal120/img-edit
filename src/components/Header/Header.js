...
var _default = /*#__PURE__*/function (_Component) {
  ...
  _createClass(_default, [{
    ...
    value: function render() {
      ...
      var onFinishButtonLabel = finishButtonLabel || (!processWithCloudService && !processWithFilerobot ? t['toolbar.CreateTemplate'] : t['toolbar.save']);
        ...
        children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_styledComponents.HeaderTop, {
          children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_styledComponents.Title, {
            ...
            /*#__PURE__*/(0, _jsxRuntime.jsx)(_styledComponents.CancelBtn, {
              ...
              themeBtn: activeTab,
              onClick: isOneTool ? applyAndSave : !activeTab ? function () {
                localStorage.setItem("tempdwn","true")
                handleSave();
              } : function () {
                apply();
              },
              id:"templateCustomDownloadBtn",
              children: t['toolbar.download']
            })]
